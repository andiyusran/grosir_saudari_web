    ...
    <div class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand">GROSIR SAUDARI</a>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a id="pesan_sedia" href="#" data-toogle="modal" data-target="#modalpesan"><span class="glyphicon glyphicon-comment"></span> Pesan</a></li>
                    <li><a class="dropdown-toogle" data-toggle="dropdown" role="button" href="#">Hi!, <?php echo $_SESSION['username'] ?>&nbsp&nbsp<span class="glyphicon glyphicon-user"></span></a></li>
                </ul>
            </div>
        </div>
    </div>
